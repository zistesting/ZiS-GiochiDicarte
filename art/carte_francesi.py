...
# Altezza di un simbolo della griglia, in frazioni del pannello.
#
# Il tetto non e' l'altezza ma la LARGHEZZA: le tre colonne di simboli hanno i centri a
# 0,28 - 0,50 - 0,72 del riquadro, cioe' a 100 px l'una dall'altra, e picche, cuori e fiori
# sono larghi quasi quanto sono alti (0,94 - 0,98). A 0,21 restano 8 px di bianco fra una
# colonna e l'altra; oltre si toccherebbero. In altezza ci sarebbe ancora margine.
PIP = 0.21
